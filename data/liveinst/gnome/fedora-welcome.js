...
const WelcomeWindow = new Lang.Class({
  ...
  _init: function(application) {
      ...
      tryContent.add(new Gtk.Image({ icon_name: 'media-optical',
                                     pixel_size: 256 }));
      tryContent.add(makeLabel(_("Try Ruya"), true));
      ...
      this._label = makeLabel(_("You are currently running Ruya from live media.\nYou can install Ruya now, or choose \"Install to Hard Drive\" in the Activities Overview at any later time."), false);
